 ...
 * @returns {number}
 */
export function crc8_compute(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.crc8_compute(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function decode_ast(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_ast(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function decode_pragmatic_simple(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_pragmatic_simple(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function decode_simple(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_simple(ptr0, len0);
    return ret;
}
 ...
 * @param {string} content
 * @param {Uint8Array} agent_id
 * @returns {Uint8Array}
 */
export function encode_pragmatic(act, topic_id, content, agent_id) {
    const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(agent_id, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.encode_pragmatic(act, topic_id, ptr0, len0, ptr1, len1);
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v3;
}
 ...
 * @returns {Uint8Array}
 */
export function encode_string(msg) {
    const ptr0 = passStringToWasm0(msg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.encode_string(ptr0, len0);
 ...
 * @returns {Uint8Array}
 */
export function encode_task_allocation(task_id, role, agent_id) {
    const ptr0 = passStringToWasm0(role, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(agent_id, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.encode_task_allocation(task_id, ptr0, len0, ptr1, len1);
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v3;
}
...
export function encode_url(url) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.encode_url(ptr0, len0);
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v2;
}
 ...
 * @returns {any}
 */
export function get_mnemonics() {
    const ret = wasm.get_mnemonics();
    return ret;
}
 ...
 * @returns {string}
 */
export function hex_dump(data, max_bytes) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hex_dump(ptr0, len0, max_bytes);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function mnemonic_for(code) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.mnemonic_for(code);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function pretty_print_bytes(data) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.pretty_print_bytes(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {boolean}
 */
export function validate_epoch(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_epoch(ptr0, len0);
    return ret !== 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('aill_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
